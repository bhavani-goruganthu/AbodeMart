...
class StoreActivity : BaseCartMenuActivity() {
...
//        val recyclerView = findViewById<RecyclerView>(R.id.rv_products_list)
...
//                myProductsList.add(ProductData(2, "Organic Sweet Tomato", R.drawable.product_sweet_tomato, "$ 2.69 /lb", storeName))
                findViewById<RecyclerView>(R.id.rv_products_list).apply {
                    ...
                    adapter = ProductsAdapter(this@StoreActivity, productDatabase, cartDatabase, storeName)
                }
            }
